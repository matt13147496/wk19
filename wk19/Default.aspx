...
＊本系課程由基礎教起並具多元選擇性，歡迎商業類、電子類、電機類的學生報考本系，無論是否有資訊基礎，皆歡迎就讀。＊</p>
                    <p>
                        <iframe id="I1" allowfullscreen="" frameborder="0" height="720" name="I1" src="https://www.youtube.com/embed/TJsfkbZqR0w" width="1280"></iframe>
                    </p>
                <div id="師資介紹">
                <h1>師資介紹</h1>
                <img src="名單.png" width="80%" />
                    <img src="名單2.png" width="80%" />
                    </div>
            </div>
            <div class="col-sm-2 sidenav">
                <div class="well">
